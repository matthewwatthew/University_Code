...
public class BirdScootersTest {
    ...
    public void testingSmallCase(){
        ...
        Node n1 = new Node(0.5, 0.5);
        bsScooters.add(n1);
        Node n2 = new Node(0.25, 0.25);
        Node n3 = new Node(0.125, 0.125);
        Node n4 = new Node(0.375, 0.375);
        Node n5 = new Node(0.75, 0.75);
        Node n6 = new Node(0.55, 0.55);
        Node n7 = new Node(0.9, 0.9);
        bsScooters.add(n2);
        bsScooters.add(n3);
        bsScooters.add(n4);
        bsScooters.add(n5);
